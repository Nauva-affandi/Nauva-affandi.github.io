(function(){const t=document.createElement("link").relList;if(t&&t.supports&&t.supports("modulepreload"))return;for(const o of document.querySelectorAll('link[rel="modulepreload"]'))l(o);new MutationObserver(o=>{for(const r of o)if(r.type==="childList")for(const a of r.addedNodes)a.tagName==="LINK"&&a.rel==="modulepreload"&&l(a)}).observe(document,{childList:!0,subtree:!0});function n(o){const r={};return o.integrity&&(r.integrity=o.integrity),o.referrerPolicy&&(r.referrerPolicy=o.referrerPolicy),o.crossOrigin==="use-credentials"?r.credentials="include":o.crossOrigin==="anonymous"?r.credentials="omit":r.credentials="same-origin",r}function l(o){if(o.ep)return;o.ep=!0;const r=n(o);fetch(o.href,r)}})();function i(e){return document.getElementById(e)}function E(){return`
  ...
  </nav>`}function $(e){e.innerHTML+=E()}const j="modulepreload",N=function(e){return"/"+e},h={},v=function(t,n,l){let o=Promise.resolve();if(n&&n.length>0){document.getElementsByTagName("link");const a=document.querySelector("meta[property=csp-nonce]"),s=(a==null?void 0:a.nonce)||(a==null?void 0:a.getAttribute("nonce"));o=Promise.allSettled(n.map(c=>{if(c=N(c),c in h)return;h[c]=!0;const p=c.endsWith(".css"),w=p?'[rel="stylesheet"]':"";if(document.querySelector(`link[href="${c}"]${w}`))return;const d=document.createElement("link");if(d.rel=p?"stylesheet":j,p||(d.as="script"),d.crossOrigin="",d.href=c,s&&d.setAttribute("nonce",s),document.head.appendChild(d),p)return new Promise((_,L)=>{d.addEventListener("load",_),d.addEventListener("error",()=>L(new Error(`Unable to preload CSS for ${c}`)))})}))}function r(a){const s=new Event("vite:preloadError",{cancelable:!0});if(s.payload=a,window.dispatchEvent(s),!s.defaultPrevented)throw a}return o.then(a=>{for(const s of a||[])s.status==="rejected"&&r(s.reason);return t().catch(r)})},D=(e,t,n)=>{const l=e[t];return l?typeof l=="function"?l():Promise.resolve(l):new Promise((o,r)=>{(typeof queueMicrotask=="function"?queueMicrotask:setTimeout)(r.bind(null,new Error("Unknown variable dynamic import: "+t+(t.split("/").length!==n?". Note that variables only represent file names one level deep.":""))))})};async function I(e,t){return(await D(Object.assign({"../databases/KANJI/N4.json":()=>v(()=>import("./N4-Dn1jJ6Zf.js"),[]),"../databases/KANJI/N5.json":()=>v(()=>import("./N5-rKq3hKfC.js"),[])}),`../databases/${e}/${t}.json`,4)).default}function y(e,t){if(e.length>1){const n=Math.max(1,Math.floor(e.length*(t/100)));e.splice(n,0,e.shift())}}function P(e){e.length>1&&(e[0].mistakeData={soft:0,hard:0},e.push(e.shift()))}function M(e){let t=e[0];if(e.length>1){t.mistakeData||(t.mistakeData={soft:0,hard:0}),t.mistakeData.soft++,t.mistakeData.hard=0;const n=Math.max(20,50-t.mistakeData.soft*3);y(e,n)}}function S(e){let t=e[0];if(e.length>1){t.mistakeData||(t.mistakeData={soft:0,hard:0}),console.log(`${t.mistakeData.soft?t.mistakeData.soft:0} ${t.mistakeData.hard?t.mistakeData.hard:0}`),t.mistakeData.soft=0,t.mistakeData.hard++;const n=Math.max(45,75-t.mistakeData.hard*3);y(e,n)}}let u=[];async function T(){let e=await I(i("parent").value,i("category_select").value);u=A(e),b()}function b(){const e=i("front"),t=i("back");e.children[0].innerHTML=u[0].k,t.children[0].children[0].innerHTML=u[0].h,t.children[0].children[1].innerHTML=u[0].i}function m(){const e=i("card-inner");e.classList.remove("card_animation"),i("card").classList.remove("rotated"),setTimeout(()=>{e.classList.toggle("card_animation")},350)}function O(){const e=i("next_card"),t=i("lupa_satu"),n=i("lupa_semuanya");e.addEventListener("click",()=>{P(u),b(),m()}),t.addEventListener("click",()=>{M(u),b(),m()}),n.addEventListener("click",()=>{S(u),b(),m()})}function A(e){for(let t=e.length-1;t>0;t--){const n=Math.floor(Math.random()*(t+1));[e[t],e[n]]=[e[n],e[t]]}return e}function H(){return`
	...
	`}function J(){[i("openSidebar"),i("closeSidebar")].forEach(e=>{e.addEventListener("click",()=>{i("sidebar").classList.toggle("-translate-x-full")})}),document.getElementById("openSidebar").addEventListener("click",()=>{R()}),document.getElementById("closeSidebar").addEventListener("click",()=>{g()}),i("fetch").addEventListener("click",()=>{g(),T(),i("sidebar").classList.toggle("-translate-x-full")})}function z(e,t,n,l){return`
	...
	`}const k=i("app.fixed"),G=i("app");$(k);q(k);Q(G);
